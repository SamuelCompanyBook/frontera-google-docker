...
id=$(docker run --name=hbase-docker -h hbase-docker --net=frontera-network --net-alias=hbase-docker -d -p 16010:16010 -p 9095:9095 -p 8085:8085 -p 9090:9090 -p 9091:9091 -v $data_dir:/data casertap/shb)
